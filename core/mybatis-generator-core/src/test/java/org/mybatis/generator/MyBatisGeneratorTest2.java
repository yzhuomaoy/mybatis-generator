...
public class MyBatisGeneratorTest2 {

    @Test
    public void testGenerateMyBatis3Config() throws Exception {
        ...
        try {
            ...
            System.out.println(myBatisGenerator.getGeneratedJavaFiles());
            System.out.println(myBatisGenerator.getGeneratedXmlFiles());
