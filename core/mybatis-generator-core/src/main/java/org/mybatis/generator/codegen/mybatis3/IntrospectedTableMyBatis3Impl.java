...
import org.mybatis.generator.codegen.mybatis3.model.ConditionGenerator;
...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    protected void calculateJavaModelGenerators(List<String> warnings,
        ...
        if (getRules().generateBaseRecordClass()) {
            ...
            AbstractJavaGenerator condGenerator = new ConditionGenerator();
            initializeAbstractGenerator(condGenerator, warnings,
                    progressCallback);
            javaModelGenerators.add(condGenerator);
        }
