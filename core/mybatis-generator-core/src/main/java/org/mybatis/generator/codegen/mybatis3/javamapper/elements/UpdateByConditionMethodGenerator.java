 ...
 * 
 */
public class UpdateByConditionMethodGenerator extends
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable
                .getUpdateByConditionStatementId());
...
//        importedTypes.add(parameterType);
        ...
        method.addParameter(new Parameter(exampleType, "conditionType")); //$NON-NLS-1$ //$NON-NLS-2$
