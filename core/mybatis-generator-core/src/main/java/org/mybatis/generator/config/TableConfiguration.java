...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean countByConditionStatementEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        countByConditionStatementEnabled = true;
    ...
    public XmlElement toXmlElement() {
        ...
        if (stringHasValue(selectByConditionQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "selectByConditionQueryId", selectByConditionQueryId)); //$NON-NLS-1$
        }
	...
	public void setSelectByConditionStatementEnabled(boolean selectByConditionStatementEnabled) {
	...
	public void setDeleteByConditionStatementEnabled(boolean deleteByConditionStatementEnabled) {
		this.deleteByConditionStatementEnabled = deleteByConditionStatementEnabled;
	}

	public boolean isCountByConditionStatementEnabled() {
		return countByConditionStatementEnabled;
	}

	public void setCountByConditionStatementEnabled(boolean countByConditionStatementEnabled) {
		this.countByConditionStatementEnabled = countByConditionStatementEnabled;
	}
	...
	public void setUpdateByConditionStatementEnabled(boolean updateByConditionStatementEnabled) {
