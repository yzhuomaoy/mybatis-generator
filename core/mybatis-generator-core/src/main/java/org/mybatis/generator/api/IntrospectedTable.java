...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_UPDATE_BY_CONDITION_STATEMENT_ID,
        ...
        ATTR_CONDITION_WHERE_CLAUSE_ID,
    ...
    public String getSelectByConditionQueryId() {
        return tableConfiguration.getSelectByConditionQueryId();
    }
     ...
     *
     * @return the type for the condition class.
     */
    public String getConditionType() {
        return internalAttributes.get(InternalAttribute.ATTR_CONDITION_TYPE);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setCountByConditionStatementId("countByCondition"); //$NON-NLS-1$
        setDeleteByExampleStatementId("deleteByExample"); //$NON-NLS-1$
        setDeleteByConditionStatementId("deleteByCondition"); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId("deleteByPrimaryKey"); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByConditionStatementId("selectByCondition"); //$NON-NLS-1$
        ...
        setUpdateByConditionStatementId("updateByCondition"); //$NON-NLS-1$
        ...
        setConditionWhereClauseId("Condition_Where_Clause"); //$NON-NLS-1$
    ...
    public void setConditionWhereClauseId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_CONDITION_WHERE_CLAUSE_ID,
                s);
    }
    ...
    public void setUpdateByConditionStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_UPDATE_BY_CONDITION_STATEMENT_ID, s);
    }
    ...
    public void setDeleteByConditionStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_DELETE_BY_CONDITION_STATEMENT_ID, s);
    }
    ...
    public void setCountByConditionStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_COUNT_BY_CONDITION_STATEMENT_ID, s);
    }
    ...
    public String getConditionWhereClauseId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_CONDITION_WHERE_CLAUSE_ID);
    }
    ...
    public String getUpdateByConditionStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_UPDATE_BY_CONDITION_STATEMENT_ID);
    }
    ...
    public String getDeleteByConditionStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DELETE_BY_CONDITION_STATEMENT_ID);
    }
    ...
    public String getCountByConditionStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_COUNT_BY_CONDITION_STATEMENT_ID);
    }
...
//        }
    ...
    public void setConditionType(String conditionType) {
        internalAttributes
                .put(InternalAttribute.ATTR_CONDITION_TYPE, conditionType);
    }
