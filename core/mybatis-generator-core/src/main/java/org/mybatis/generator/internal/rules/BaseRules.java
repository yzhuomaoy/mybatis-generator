...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateSQLConditionWhereClause() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSelectByConditionStatementEnabled()
                || tableConfiguration.isDeleteByConditionStatementEnabled()
                || tableConfiguration.isCountByConditionStatementEnabled();

        if (introspectedTable.getTargetRuntime() == TargetRuntime.IBATIS2) {
            rc |= tableConfiguration.isUpdateByConditionStatementEnabled();
        }
    ...
    public boolean generateSelectByCondition() {
        if (isModelOnly) {
            return false;
        }
    ...
    public boolean generateCountByCondition() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isCountByConditionStatementEnabled();
    ...
    public boolean generateUpdateByCondition() {
        if (isModelOnly) {
            return false;
        }
