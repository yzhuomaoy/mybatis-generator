...
public interface Rules {
    ...
    boolean generateDeleteByCondition();
    ...
    boolean generateSQLConditionWhereClause();
    ...
    boolean generateSelectByCondition();
    ...
    boolean generateCountByCondition();

    boolean generateUpdateByExampleSelective();
    
    boolean generateUpdateByCondition();
