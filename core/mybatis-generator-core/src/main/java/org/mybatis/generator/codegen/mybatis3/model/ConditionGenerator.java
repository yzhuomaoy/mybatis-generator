...
//            	Field startField = field.clone();
//            	startField.setName(introspectedColumn.getJavaProperty("start"));
//            	topLevelClass.addField(startField);
//            	Field endField = field.clone();
//            	endField.setName(introspectedColumn.getJavaProperty("end"));
