...
public class RulesDelegate implements Rules {
    ...
    public boolean generateCountByCondition() {
        return rules.generateCountByCondition();
    }
    ...
    public boolean generateDeleteByCondition() {
        return rules.generateDeleteByCondition();
    }
    ...
    public boolean generateSelectByCondition() {
        return rules.generateSelectByCondition();
    }
    ...
    public boolean generateSQLConditionWhereClause() {
        return rules.generateSQLConditionWhereClause();
    }
    ...
    public boolean generateUpdateByCondition() {
        return rules.generateUpdateByCondition();
    }
