...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ConditionWhereClauseElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.CountByConditionElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.CountByExampleElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteByConditionElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByConditionElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByConditionElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addConditionWhereClauseElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSQLConditionWhereClause()) {
    ...
    protected void addSelectByConditionElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectByCondition()) {
    ...
    protected void addCountByConditionElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateCountByCondition()) {
    ...
    protected void addUpdateByConditionSelectiveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByCondition()) {
